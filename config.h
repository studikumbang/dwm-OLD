...
static const char *shtct[]  = { "sxhkd", NULL };
...
//brightness
static const char *upbrig[] = { "xbacklight", "-inc", "5",  NULL };
static const char *downbrig[] = { "xbacklight", "-dec", "5",  NULL };
